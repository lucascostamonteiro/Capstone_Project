...
# def validation_booking(form, field):
#     listing_id = field.data
#     booking = form.data

#     if(booking["start_date"] == None):
#         return {'errors': ["Please provide a start date"]}
...
#             if ((start_date_year == booking_start_date_year)and (start_date_month == booking_start_date_month) and (int(start_date_day) >= int(booking_start_date_day))):
#                 if(int(start_date_year) < int(booking_end_date_year)):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")

#                 if((start_date_year == booking_end_date_year) and(int(start_date_month) < int(booking_end_date_month))):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")
...
#             if ((end_date_year == booking_start_date_year) and (end_date_month == booking_start_date_month) and (int(end_date_day) >= int(booking_start_date_day))):

#                 if(int(end_date_year) < int(booking_end_date_year)):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")

#                 if((end_date_year == booking_end_date_year) and (int(end_date_month) < int(booking_end_date_month))):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")
...
#             if ((booking_start_date_year == start_date_year) and (booking_start_date_month == start_date_month) and (int(booking_start_date_day) >= int(start_date_day))):
#                 if(int(booking_start_date_year) < int(end_date_year)):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")

#                 if((booking_start_date_year == end_date_year) and(int(booking_start_date_month) < int(end_date_month))):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")
...
#             if ((booking_end_date_year == start_date_year) and (booking_end_date_month == start_date_month) and (int(booking_end_date_day) >= int(start_date_day))):
#                 if(int(booking_end_date_year) < int(end_date_year)):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")

#                 if((booking_end_date_year == end_date_year) and (int(booking_end_date_month) < int(end_date_month))):
#                     raise ValidationError(f"This listing is already booked from {booking_start_date} and {booking_end_date}")
