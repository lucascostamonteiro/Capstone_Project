...
class SignUpForm(FlaskForm):
    ...
    email = StringField('email', validators=[DataRequired(message="Email is required"), Email("Must be a valid email."), Length(min=1, max=255, message="Email must be between 1-50 characters"), user_exists])
