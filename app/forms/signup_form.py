...
class SignUpForm(FlaskForm):
    username = StringField('username', validators=[DataRequired(message="Username is required"), Length(min=5, max=15, message='Username must be between 5-15 characters'), username_exists])
